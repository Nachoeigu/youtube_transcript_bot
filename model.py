...
def check_if_sponsored(driver):
    if driver.find_elements(By.XPATH, "//*[text()='Sponsored']") != []:
        time.sleep(10)
        check_if_sponsored(driver)
    else:
        return
...
class YoutubeBot:
    ...
    def get_transcript(self, url):
        ...
        check_if_sponsored(self.driver)
        ...
        while True:
            ...
            if content != '':
                break
            if condition > 3:
                raise NoTranscript("No transcript found")
